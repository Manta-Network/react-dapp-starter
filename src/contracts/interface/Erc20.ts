...
export interface Erc20Interface extends utils.Interface {
  functions: {
    ...
    'maxHoldingAmount()': FunctionFragment;
    'minHoldingAmount()': FunctionFragment;
  ...
  encodeFunctionData(functionFragment: 'blacklists', values: [string]): string;
...
export interface Erc20 extends BaseContract {
  ...
  functions: {
    ...
    blacklist(
      _address: string,
      _isBlacklisting: boolean,
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;

    blacklists(arg0: string, overrides?: CallOverrides): Promise<[boolean]>;
    ...
    maxHoldingAmount(overrides?: CallOverrides): Promise<[BigNumber]>;

    minHoldingAmount(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  estimateGas: {
    ...
    blacklists(arg0: string, overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    maxHoldingAmount(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    minHoldingAmount(overrides?: CallOverrides): Promise<PopulatedTransaction>;
